...
const Footer = () => {
  ...
  const servicesPrefix = isBangalore ? "/bangalore/services" : "/services";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="grid grid-cols-2 gap-x-6 gap-y-2 text-sm text-primary-foreground/70 font-body">
              <li><a href={`${servicesPrefix}/modular-kitchen`} className="hover:text-secondary transition-colors">Modular Kitchens</a></li>
              <li><a href={`${servicesPrefix}/bedroom-design`} className="hover:text-secondary transition-colors">Bedroom Interiors</a></li>
              <li><a href={`${servicesPrefix}/living-room`} className="hover:text-secondary transition-colors">Living Room</a></li>
              <li><a href={`${servicesPrefix}/wardrobe-design`} className="hover:text-secondary transition-colors">Wardrobes</a></li>
              <li><a href={`${servicesPrefix}/tv-unit`} className="hover:text-secondary transition-colors">TV Units</a></li>
              <li><a href={`${servicesPrefix}/pooja-room`} className="hover:text-secondary transition-colors">Pooja Room</a></li>
              <li><a href={`${servicesPrefix}/2bhk-interiors`} className="hover:text-secondary transition-colors">2 BHK Interiors</a></li>
              <li><a href={`${servicesPrefix}/3bhk-interiors`} className="hover:text-secondary transition-colors">3 BHK Interiors</a></li>
              <li><a href={`${servicesPrefix}/villa-interiors`} className="hover:text-secondary transition-colors">Villa Interiors</a></li>
              <li><a href={`${servicesPrefix}/full-home-design`} className="hover:text-secondary transition-colors">Full Home Design</a></li>
              <li><a href={`${servicesPrefix}/home-office`} className="hover:text-secondary transition-colors">Home Office</a></li>
              <li><a href={`${servicesPrefix}/kids-room`} className="hover:text-secondary transition-colors">Kids Room</a></li>
              <li><a href={`${servicesPrefix}/dining-room`} className="hover:text-secondary transition-colors">Dining Room</a></li>
              <li><a href={`${servicesPrefix}/bathroom-design`} className="hover:text-secondary transition-colors">Bathroom Design</a></li>
              <li><a href={`${servicesPrefix}/foyer-entrance`} className="hover:text-secondary transition-colors">Foyer &amp; Entrance</a></li>
              <li><a href={`${servicesPrefix}/false-ceiling`} className="hover:text-secondary transition-colors">False Ceiling</a></li>
              <li><a href={`${servicesPrefix}/crockery-unit`} className="hover:text-secondary transition-colors">Crockery Unit</a></li>
              <li><a href={`${servicesPrefix}/study-room`} className="hover:text-secondary transition-colors">Study Room</a></li>
              <li><a href={`${servicesPrefix}/guest-room`} className="hover:text-secondary transition-colors">Guest Room</a></li>
              <li><a href={`${servicesPrefix}/balcony-design`} className="hover:text-secondary transition-colors">Balcony Design</a></li>
              <li><a href={servicesPrefix} className="hover:text-secondary transition-colors font-medium">View All Services →</a></li>
            </ul>
          </div>
