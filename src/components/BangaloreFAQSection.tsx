...
const bangaloreFaqs = [
  ...
  },
  {
    ...
    answer:
      "Most Bangalore apartments have compact kitchens (50-80 sq ft), making L-shaped and parallel layouts the most practical. L-shaped kitchens maximize corner space and work well in 2BHK/3BHK apartments across Whitefield and Sarjapur Road. Parallel kitchens suit narrow galley-style kitchens common in older Koramangala and Indiranagar buildings. For larger villa kitchens in Sadashivanagar or Hebbal, U-shaped or island layouts are ideal.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Timeline varies by scope: Modular kitchen only takes 15-20 working days, a 2BHK full home interior takes 45-55 days, and a 3BHK or villa takes 60-90 days. Bangalore-specific factors like society working hour restrictions (typically 9 AM-6 PM), freight elevator availability, and monsoon season can affect timelines. We provide a detailed project schedule upfront and assign a dedicated project manager for daily updates.",
  },
];
