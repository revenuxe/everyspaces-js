...
const tvUnitFAQs = [
  {
    question: "What is the cost of TV unit design ?",
    answer: "TV unit design  costs â‚¹25,000 to â‚¹1.5 lakh depending on size and design. At EverySpaces, floating units start from â‚¹25,000, wall-mounted panels from â‚¹40,000, and floor-to-ceiling entertainment walls from â‚¹80,000."
  },
  {
    question: "Which TV unit design is trending ?",
    answer: "Trending TV unit designs  include floating wall-mounted units, backlit stone panels, floor-to-ceiling entertainment walls with LED lighting, and minimalist designs with hidden storage. EverySpaces offers all these styles."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, EverySpaces specializes in TV units with feature walls including stone cladding, wooden panels, PU finish, textured wallpaper, and backlit panels. Prices start from â‚¹60,000 for TV unit with feature wall."
  }
];
...
const ServiceTVUnit = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackAdsAction("lead", "TV Unit Design Page Form");
  ...
  const aeoSchemas = [
    createServiceSchema(
      "TV Unit Design",
      "Modern TV unit and entertainment wall designs . Floating units, backlit panels, stone accent walls with LED lighting and cable management.",
    ...
    createProductSchema({
      ...
      description: "Modern TV unit designs  with floating units, backlit panels, and feature walls. Includes cable management and LED lighting.",
      ...
      <main className="pb-24">
        <section className="service-hero relative min-h-[100dvh] flex items-start overflow-hidden pt-20 pb-24 md:items-center md:py-20 md:pt-24">
          <div className="absolute inset-0 z-0">
            <img src={imgSrc(tvUnitImage)} alt="TV Unit Design" className="w-full h-full object-cover scale-105" />
