...
const livingRoomFAQs = [
  {
    ...
    answer: "Living room interior design  costs â‚¹1-2.5 lakh depending on size and finishes. At EverySpaces, packages include TV unit, false ceiling, feature wall, and lighting. Basic packages start from â‚¹80,000."
  },
  {
  ...
  {
    question: "What TV unit designs are trending ?",
    answer: "Popular TV unit designs  include floating wall-mounted units, floor-to-ceiling entertainment walls, minimalist designs with hidden storage, and units with integrated LED backlighting. EverySpaces offers all these styles."
  }
];
...
const ServiceLivingRoom = () => {
  ...
  const aeoSchemas = [
    createServiceSchema(
      ...
      "Expert living room designers  offering TV units, false ceilings, feature walls, and smart lighting solutions.",
    ...
    createProductSchema({
      ...
      description: "Complete living room design  including TV unit, false ceiling, feature wall, and lighting. 10-year warranty included.",
      ...
      <main className="pb-24">
        <section className="service-hero relative min-h-[100dvh] flex items-start overflow-hidden pt-20 pb-24 md:items-center md:py-20 md:pt-24">
          <div className="absolute inset-0 z-0">
            <img src={imgSrc(livingImage)} alt="Smart Living Room Design" className="w-full h-full object-cover scale-105" />
