      ...
      <main className="pb-24">
        <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden py-20 pt-24">
          <div className="absolute inset-0 z-0">
            <img src={imgSrc(villaImage)} alt="Foyer Design Bangalore" className="w-full h-full object-cover scale-105" />
            ...
            <div className="max-w-sm mx-auto animate-fade-up delay-300">
              <div className="glass-card rounded-3xl p-5 shadow-elevated">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <input type="text" placeholder="Project Type (e.g., Foyer, Shoe Cabinet)" value={formData.projectType} onChange={(e) => setFormData({ ...formData, projectType: e.target.value })} required className="w-full px-4 py-3.5 bg-background/60 border-2 border-border rounded-2xl text-sm focus:border-secondary transition-all" />
        ...
        <RelatedLocalities currentSlug="hebbal" />
