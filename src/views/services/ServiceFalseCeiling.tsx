...
const falseCeilingFAQs = [
  {
    question: "What is the cost of false ceiling ?",
    answer: "False ceiling  costs â‚¹65-150 per sq ft depending on material and design. At EverySpaces, basic POP ceilings start from â‚¹65/sq ft, gypsum from â‚¹85/sq ft, and designer ceilings with cove lighting from â‚¹120/sq ft."
  },
  {
...
const ServiceFalseCeiling = () => {
  ...
  const aeoSchemas = [
    createServiceSchema(
      ...
      "Artistic false ceiling designs . POP, gypsum, wooden ceilings with cove lighting, multi-level designs, and AC integration.",
    ...
    createProductSchema({
      ...
      description: "Designer false ceilings  with POP, gypsum, cove lighting, and AC integration. 3-7 day installation.",
      ...
      <main className="pb-24">
        <section className="service-hero relative min-h-[100dvh] flex items-start overflow-hidden pt-20 pb-24 md:items-center md:py-20 md:pt-24">
          <div className="absolute inset-0 z-0">
            <img src={imgSrc(livingImage)} alt="False Ceiling Design" className="w-full h-full object-cover scale-105" />
        ...
        <RelatedLocalities currentSlug="bellandur" />
