...
const ServiceBedroom = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackAdsAction("lead", "Bedroom Design Page Form");
            ...
            <div className="max-w-sm mx-auto animate-fade-up delay-300">
              <div className="glass-card rounded-3xl p-5 shadow-elevated">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <input type="text" placeholder="Project Type (e.g., Master Bedroom, Kids Room)" value={formData.projectType} onChange={(e) => setFormData({ ...formData, projectType: e.target.value })} required className="w-full px-4 py-3.5 bg-background/60 border-2 border-border rounded-2xl text-sm focus:border-secondary transition-all" />
