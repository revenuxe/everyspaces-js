...
const crockeryUnitFAQs = [
  {
    question: "What is the cost of crockery unit ?",
    answer: "Crockery unit  costs â‚¹40,000 to â‚¹1.5 lakh depending on size and design. At EverySpaces, wall-mounted units start from â‚¹40,000, floor units from â‚¹60,000, and bar+crockery combos from â‚¹1 lakh."
  },
  {
...
const ServiceCrockeryUnit = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackAdsAction("lead", "Crockery Unit Design Page Form");
  ...
  const aeoSchemas = [
    createServiceSchema(
      ...
      "Elegant crockery unit designs . Glass display cabinets, bar units, partition units with LED lighting and mirror backing.",
    ...
    createProductSchema({
      ...
      description: "Elegant crockery units  with glass displays, LED lighting, and bar sections for fine china and beverages.",
      ...
      <main className="pb-24">
        <section className="service-hero relative min-h-[100dvh] flex items-start overflow-hidden pt-20 pb-24 md:items-center md:py-20 md:pt-24">
          <div className="absolute inset-0 z-0">
            <img src={imgSrc(kitchenImage)} alt="Crockery Unit Design" className="w-full h-full object-cover scale-105" />
