...
const contactFAQs = [
  ...
  },
  {
    ...
    answer: "No, EverySpaces provides a completely free initial consultation and site visit anywhere in Bangalore. There's no obligation to proceed after the consultation. We'll share design ideas and cost estimates during the visit."
  }
];
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-3xl p-6 border border-secondary/20">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-secondary hover:bg-secondary/90 text-secondary-foreground px-6 py-3 rounded-2xl font-semibold transition-colors"
                  >
                ...
                <div className="rounded-3xl overflow-hidden shadow-soft border border-border/50">
                  <iframe
                    ...
                    title="EverySpaces Office Location - Bangalore"
                  ></iframe>
                </div>
              </div>
            </div>
