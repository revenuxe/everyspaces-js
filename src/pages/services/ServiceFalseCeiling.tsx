...
const ServiceFalseCeiling = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>False Ceiling Design Bangalore | POP Ceiling | Intorza</title>
        <meta name="description" content="Best false ceiling designers in Bangalore. POP, gypsum, wooden ceilings with cove lighting. Artistic ceiling designs. Get free quote!" />
        <meta name="keywords" content="false ceiling design bangalore, POP ceiling, gypsum ceiling, cove lighting ceiling, living room ceiling" />
              ...
              <div className="glass-card rounded-3xl p-5 shadow-elevated">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <select value={formData.projectType} onChange={(e) => setFormData({ ...formData, projectType: e.target.value })} className="w-full px-4 py-3.5 bg-background/60 border-2 border-border rounded-2xl text-sm focus:border-secondary transition-all">
                    <option value="False Ceiling">Single Room</option>
                    <option value="Full Home Ceiling">Full Home Ceiling</option>
                    <option value="Living Room">Living Room Only</option>
                    <option value="Bedroom Ceiling">Bedroom Ceiling</option>
                  </select>
