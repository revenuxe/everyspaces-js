  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Best guest room interior designers in Bangalore. Comfortable guest bedrooms, sofa-cum-bed designs, multi-purpose rooms. Get free quote!" />
        <meta name="keywords" content="guest room design bangalore, guest bedroom interior, spare room design, sofa cum bed design, guest room furniture" />
              ...
              <div className="glass-card rounded-3xl p-5 shadow-elevated">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <select value={formData.projectType} onChange={(e) => setFormData({ ...formData, projectType: e.target.value })} className="w-full px-4 py-3.5 bg-background/60 border-2 border-border rounded-2xl text-sm focus:border-secondary transition-all">
                    ...
                    <option value="Multi-Purpose">Multi-Purpose Room</option>
                    <option value="Sofa Bed Room">Sofa-Cum-Bed Room</option>
                    <option value="Luxury Suite">Luxury Guest Suite</option>
                  </select>
