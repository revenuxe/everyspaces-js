...
const Bangalore = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Interior Designers in Bangalore | Top-Rated Home Interiors | EverySpaces</title>
        <meta
          name="description"
          content="Looking for interior designers in Bangalore? EverySpaces offers premium modular kitchens, wardrobes & home interiors across Whitefield, Koramangala, HSR Layout & more. 500+ projects, 10-year warranty, 45-day delivery!"
        />
        <meta
          name="keywords"
        ...
        />
        <link rel="canonical" href="https://everyspaces.com/bangalore" />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Interior Designers in Bangalore | 500+ Projects | EverySpaces" />
        ...
        <meta property="og:url" content="https://everyspaces.com/bangalore" />
